    	...
    	$('#inputCity').change(function(){ 
    		$.ajax({
     			...
     			data: {
    		  	...
    		  	success: function(data) {
    		  		$("#inputDistrict").empty();
    		  		$("#inputDistrict").append('<option value="0">选择城区</option>');
    		  		for(var i = 0; i < data.data.length; i++){
    					$("#inputDistrict").append('<option value="' + data.data[i].id + '"> ' + data.data[i].code + '-' + data.data[i].name + '</option>');
    				}
      			}
    		});
    	});
		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title" id="myModalLabel">新增村镇</h4>
		            ...
		            <div class="modal-body">
		                ...
		                <div class="form-group">
		                	<label for="inputName" class="col-sm-2 control-label">村镇名称</label>
		                	<div class="col-sm-10">
		                	<input type="text" class="form-control" id="inputName">
		                	</div>
		                </div>
		                <div class="form-group">
		                	<label for="inputCode" class="col-sm-2 control-label">村镇代码</label>
		                	<div class="col-sm-10">
